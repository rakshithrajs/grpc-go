...
// LoginUserResponse contains the JWT token for the user to use to access
...
const file_auth_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x12auth/v1/auth.proto\x12\aauth.v1\x1a\x14users/v1/users.proto\"q\n" +
	...
	"\x05token\x18\x01 \x01(\tR\x05token2\x97\x01\n" +
	"\x04Auth\x12K\n" +
	"\fRegisterUser\x12\x1c.auth.v1.RegisterUserRequest\x1a\x1d.auth.v1.RegisterUserResponse\x12B\n" +
	"\tLoginUser\x12\x19.auth.v1.LoginUserRequest\x1a\x1a.auth.v1.LoginUserResponseB\x12Z\x10gen/auth/v1;authb\x06proto3"
...
var file_auth_v1_auth_proto_goTypes = []any{
	...
	(*v1.User)(nil),              // 4: users.v1.User
}
var file_auth_v1_auth_proto_depIdxs = []int32{
	4, // 0: auth.v1.RegisterUserResponse.user:type_name -> users.v1.User
	0, // 1: auth.v1.Auth.RegisterUser:input_type -> auth.v1.RegisterUserRequest
	2, // 2: auth.v1.Auth.LoginUser:input_type -> auth.v1.LoginUserRequest
	1, // 3: auth.v1.Auth.RegisterUser:output_type -> auth.v1.RegisterUserResponse
	3, // 4: auth.v1.Auth.LoginUser:output_type -> auth.v1.LoginUserResponse
