...
const file_files_v1_files_proto_rawDesc = "" +
	"\n" +
	"\x14files/v1/files.proto\x12\x05files\"j\n" +
	"\x04File\x12\x0e\n" +
	...
	"\x04file\x18\x01 \x03(\v2\v.files.FileR\x04file2\xd9\x02\n" +
	"\x05files\x12A\n" +
	"\n" +
	"UploadFile\x12\x18.files.UploadFileRequest\x1a\x19.files.UploadFileResponse\x12G\n" +
	"\fDownloadFile\x12\x1a.files.DownloadFileRequest\x1a\x1b.files.DownloadFileResponse\x12>\n" +
	"\tListFiles\x12\x17.files.ListFilesRequest\x1a\x18.files.ListFilesResponse\x12A\n" +
	"\n" +
	"DeleteFile\x12\x18.files.DeleteFileRequest\x1a\x19.files.DeleteFileResponse\x12A\n" +
	"\n" +
	"RenameFile\x12\x18.files.RenameFileRequest\x1a\x19.files.RenameFileResponseB\x14Z\x12gen/files/v1;filesb\x06proto3"
...
var file_files_v1_files_proto_goTypes = []any{
	...
	(*DownloadFileRequest)(nil),  // 3: files.DownloadFileRequest
	(*DownloadFileResponse)(nil), // 4: files.DownloadFileResponse
	(*DeleteFileRequest)(nil),    // 5: files.DeleteFileRequest
	(*DeleteFileResponse)(nil),   // 6: files.DeleteFileResponse
	(*RenameFileRequest)(nil),    // 7: files.RenameFileRequest
	(*RenameFileResponse)(nil),   // 8: files.RenameFileResponse
	(*ListFilesRequest)(nil),     // 9: files.ListFilesRequest
	(*ListFilesResponse)(nil),    // 10: files.ListFilesResponse
}
var file_files_v1_files_proto_depIdxs = []int32{
	0,  // 0: files.UploadFileResponse.file:type_name -> files.File
	0,  // 1: files.ListFilesResponse.file:type_name -> files.File
	1,  // 2: files.files.UploadFile:input_type -> files.UploadFileRequest
	3,  // 3: files.files.DownloadFile:input_type -> files.DownloadFileRequest
	9,  // 4: files.files.ListFiles:input_type -> files.ListFilesRequest
	5,  // 5: files.files.DeleteFile:input_type -> files.DeleteFileRequest
	7,  // 6: files.files.RenameFile:input_type -> files.RenameFileRequest
	2,  // 7: files.files.UploadFile:output_type -> files.UploadFileResponse
	4,  // 8: files.files.DownloadFile:output_type -> files.DownloadFileResponse
	10, // 9: files.files.ListFiles:output_type -> files.ListFilesResponse
	6,  // 10: files.files.DeleteFile:output_type -> files.DeleteFileResponse
	8,  // 11: files.files.RenameFile:output_type -> files.RenameFileResponse
